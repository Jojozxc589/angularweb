...
export class AddevenComponent implements OnInit {
  ...
  loadBookings(): void {
    this.http.get<any>('https://wag7.bowlab.net/angular-webpro/getBookingsWithNullEvent')
      .subscribe(
  ...
  loadEvents(): void {
    this.http.get<any>('https://wag7.bowlab.net/angular-webpro/getAllEvents1')
      .subscribe(
  ...
  addNewEvent() {
    if (this.eventForm.valid) {
      this.http.post('https://wag7.bowlab.net/angular-webpro/addEvent14', this.eventForm.value)
        .subscribe(
          response => {
  ...
  updateEventCode(bookingId: number, eventCode: string): void {
    ...
    this.http.post('https://wag7.bowlab.net/angular-webpro/updateEventCode', body)
      .subscribe(
